...
namespace Domain.Services
{
    public class ServiceFuncionario : IServiceFuncionario
    {
        ...
        public async Task<List<FuncionarioAtendimento>> ListarFuncionarioAtendimento(int? idAtendimento, int? idFuncionario, int? idEmpresa) => await _IFuncionario.FuncionarioAtendimento(idAtendimento, idFuncionario, idEmpresa);
        ...
        public async Task<List<FuncionarioEmpresaCargoSetor>> ListarFuncionarioEmpresaCargoSetor(int? id, int? idFuncionario, string? nome, string? empresa, string? unidade) => await _IFuncionario.ListarEmpresaCargoSetor(id, idFuncionario, nome, empresa, unidade);
